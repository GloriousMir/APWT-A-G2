...
export default function StudentUserLayout(props) {
   ...
   const updateadmin = async () =>{
    ...
    <div class="flex flex-col items-center pb-10">
        ...
        <div class="flex mt-4 space-x-3 md:mt-6">
            ...
            <a href="#"onClick={() => router.push('/admin/getstudents')} class="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-green-700 rounded-lg hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 dark:bg">Back </a>
        </div>
        </div>
    </div>
    </div>  
